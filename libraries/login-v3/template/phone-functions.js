(function () {
    ...
    document.getElementById("location").setAttribute("value", ChaosLoacation.Name); // 注册表单地市定位字段
    document.getElementsByClassName("hlp-bottom")[0].setAttribute("href", ChaosLoacation.URL); // 广告位URL地址
    document.getElementsByClassName("ad-button")[0].setAttribute("href", ChaosLoacation.URL); // 广告位URL地址
    ...
    document.getElementById("sign-up").addEventListener("click", function(){
        ...
        if (check(phone)) {
            ...
            ChaosFunctions.DynamicLoading.JS("http://zg99.offcn.com/index/biaodan/register?callback=ChaosCallback&actid=" + ChaosForm + "&phone=" + phone + "&yzm=" + code + "&ds=" + ChaosLoacation.Name);
        }
    });
    // 获取验证码按钮
